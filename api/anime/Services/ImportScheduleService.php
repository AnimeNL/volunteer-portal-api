...
class ImportScheduleService implements Service {
    ...
    private function resolveEventId($eventId, $time) : int {
        ...
        switch ($eventId) {
            case 'SPECIAL1':  // Rehearsals
                if ($time <= strtotime('2019-06-14 12:30:00'))
                    return 41787;  // Friday Rehearsal
                else if ($time <= strtotime('2019-06-15 11:30:00'))
                    return 41794;  // Band rehearsal
